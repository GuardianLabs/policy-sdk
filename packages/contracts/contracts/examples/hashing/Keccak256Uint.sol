...
import { UINT, BYTES } from "../../sdk/erc-8006/constants/Export.sol";
...
contract Keccak256Uint is StatelessArtifactBase {
    ...
    function description() external pure override returns (string memory desc) {
        desc = _makeDescription(
            "used to compute keccak256 hash of a uint value. Parameter - uint value to hash. Returns bytes representing the computed hash."
        );
    }
