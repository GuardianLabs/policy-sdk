...
import { IPolicyClient, PolicyClientBuildable, PolicyDeployer } from '../src';
import { CalculatedFeeProvider } from '../src/fee-provider';
...
describe('Policy: client usage', () => {
  ...
  before(async () => {
    ...
    policyDeployer.addFactoryAddress(Number(chainId!), policyFactoryAddress);
