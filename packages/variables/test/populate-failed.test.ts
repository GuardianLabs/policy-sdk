...
describe('Populate variables: failures', () => {
  ...
  // todo: implement using stub/mock
  describe.skip('unreachable failures', () => {
    // note: UNREACHABLE: the "getVarDescription" is always searching the variable before it's node, so it's "Cannot find variable" error coming first, not "Not found node id for variable"
    ...
    // note: UNREACHABLE: non-initialized [] inserter is not possible using populator
    describe('NodeVariablesAreUndefinedErr', () => {
    ...
    // note: UNREACHABLE: insert is validating far before validateAllFilled does
